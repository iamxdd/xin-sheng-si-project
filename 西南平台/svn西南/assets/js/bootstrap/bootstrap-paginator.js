...
(function ($) {
    ...
    BootstrapPaginator.prototype = {
        ...
        render: function () {
            ...
            if(this.totalPages>1){
            var itemHtml = "<span><input type='text' value='"+this.currentPage+"'/>/"+this.totalPages+"</span>";
           ...
           if(this.totalPages>1){
             var itemTz = $("<span>确定</span>").on("click",null,{type: 'jump'},$.proxy(this.onPageItemJumped, this));//绑定点击事件
